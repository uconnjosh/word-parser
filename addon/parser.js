TextParser = {
  ...
  init: function() {
      ...
      // $('#document').attr("data-words", this.words);
      // $('#word_cloud').jQCloud(this.words, {root: this.root, width: 295, height: 345});
      // $('#word_cloud').jQCloud $('#document').data('words'), {root: root, width: 295, height: 345}
      return this;
  },
  ...
  to_json: function() {
    // this.sentences = JSON.stringify(this.full_sentences);
    }
}